...
public class DemoApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Account ac1 = new Account(null, sdf.parse("20/02/2020"), 200.00);
		Account ac2 = new Account(null, sdf.parse("19/02/2020"), 400.00);

		accountRepository.saveAll(Arrays.asList(ac1,ac2));

		Client c1 = new Client(null, "Josildo Teste", "12659459690", sdf.parse("20/02/2020"), ac1);
		Client c2 = new Client(null, "Joseph Teste", "67611680668", sdf.parse("19/02/2020"), ac2);
...
//		ac1.getTransactionsSource().addAll(Arrays.asList(t1,t2));
//		ac1.getTransactionTarget().addAll(Arrays.asList(t1,t2));
